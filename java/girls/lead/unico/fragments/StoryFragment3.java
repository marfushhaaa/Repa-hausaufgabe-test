...
public class StoryFragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.story_fragment3, null);
        storyImg = view.findViewById(R.id.story_img3);
        storyImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((StoryActivity)getActivity()).changeFragment(new StoryFragment4());
            }
        });
